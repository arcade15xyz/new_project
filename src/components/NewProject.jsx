...
export default function NewProject({onAdd ,onCancel}){
    ...
    return <>
        <Modal ref={modal} buttonCaption="Okay">
            ...
            <p className=' text-stone-600 mb-4'>Oops ... lookes like you forgot to enter a value</p>
            <p className=' text-stone-600 mb-4'>Please ake sure you provide a valid value for every input field.</p>
        </Modal>
